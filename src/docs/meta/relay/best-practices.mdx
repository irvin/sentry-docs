  ...
  <tr>
    ...
    <td>
      <ul>
        ...
        <li>
          Multi-core CPU <a href="#section1">[1]</a>
        </li>
      </ul>
    </td>
  </tr>
...
<p id="section1" markdown="1"> [1] Relay is a multi-threaded application that tries to leverage all available CPU cores. As a result, Sentry highly recommends running Relay on multi-core CPUs. If your setup is expected to handle more than 100 requests per second, we recommend running running Relay on at least four (4) CPU cores.
